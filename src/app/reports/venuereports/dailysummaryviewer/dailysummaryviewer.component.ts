...
@Component({
  selector: 'app-dailysummaryviewer',
  templateUrl: './dailysummaryviewer.component.html'
})
export class DailySummaryViewerComponent implements OnInit {
  ...
  doReportRefresh() {
    ...
    source.parameters.beginDate = this.beginDateTime;
    source.parameters.endDate = this.endDateTime;
